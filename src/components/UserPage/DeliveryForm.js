  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await fetch(
        "https://bytetype-cea685bb8e38.herokuapp.com/api/parcels/delivery",
        {
          method: "POST",
          headers: {
    ...
    <form className="delivery-form" onSubmit={handleSubmit}>
      ...
      <div className="form-bottom">
        ...
        <label className="locker-select">
          ...
          >
            <option value={[1]}>locker1</option>
            <option value={[2]}>locker2</option>
            <option value={[3]}>locker3</option>
            <option value={[4]}>locker4</option>
            <option value={[5]}>locker5</option>
          </select>
        </label>
      </div>
